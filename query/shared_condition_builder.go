...
type SharedConditionBuilder[T ast.Primitive | time.Time] struct {
	ConditionBuilder[QueryBuilder]
}

// NewSharedConditionBuilder instantiates a new base condition builder.
func NewSharedConditionBuilder[T ast.Primitive | time.Time](field string, query *QueryBuilder) *SharedConditionBuilder[T] {
