...
// NewSubObjectsRequestBuilder instantiates a new [SubObjectsRequestBuilder] with a raw URL and request adapter.
func NewSubObjectsRequestBuilder(
	rawURL string,
	requestAdapter abstractions.RequestAdapter,
) *SubObjectsRequestBuilder {
	return NewSubObjectsRequestBuilderInternal(map[string]string{internal.RawURLKey: rawURL}, requestAdapter)
}

// Get sends a GET request to retrieve subscribable objects.
func (rB *SubObjectsRequestBuilder) Get(ctx context.Context, config *SubObjectsRequestBuilderGetRequestConfiguration) (*core.BaseServiceNowCollectionResponse[*ActivitySubscription], error) {
