...
// TODO: implement tests
func TestBaseServiceNowCollectionResponse_GetNextLink(t *testing.T) {
	tests := []struct {
		name string
		test func(*testing.T)
	}{}
...
// TODO: implement tests
func TestBaseServiceNowCollectionResponse_GetPreviousLink(t *testing.T) {
	tests := []struct {
		name string
		test func(*testing.T)
	}{}
...
// TODO: implement tests
func TestBaseServiceNowCollectionResponse_GetFirstLink(t *testing.T) {
	tests := []struct {
		name string
		test func(*testing.T)
	}{}
...
// TODO: implement tests
func TestBaseServiceNowCollectionResponse_GetLastLink(t *testing.T) {
	tests := []struct {
		name string
		test func(*testing.T)
	}{}
