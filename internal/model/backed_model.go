...
type BackedModelAccessorFunc[S store.BackingStore, T any] utils.BackedModelAccessorFunc[S, T]
...
type BackedModelMutatorFunc[S store.BackingStore, T any] utils.BackedModelMutatorFunc[S, T]
...
func DefaultBackedModelMutatorFunc[S store.BackingStore, T any](backingStore S, key string, value T) error {
	return utils.DefaultBackedModelMutatorFunc[S, T](backingStore, key, value)
}
