...
type Token struct {
	...
	AccessToken string `json:"access_token"` //nolint:gosec // G117: DTO field, not a hardcoded credential
	...
	RefreshToken string `json:"refresh_token,omitempty"` //nolint:gosec // G117: DTO field, not a hardcoded credential
