...
- Save specs to `website/docs/contributing/proposals/<kebab-case-title>.md` (create the directory
...
- Before writing, check `website/docs/contributing/adr/*.md` for the highest existing ADR number.
...
- If the spec adds to or changes a cross-cutting convention this repo tracks
  ...
  `website/docs/contributing/adr/<NNN>-<title>.md` following the Status/Context/Decision/
  Consequences shape used by the existing ADRs (`website/docs/contributing/adr/001-*.md` through
  `010-*.md` are good references for tone and structure).
...
- Read a couple of existing `website/docs/contributing/adr/*.md` files before drafting a new one
