...
<head>
    <meta charset="utf-8">
""" + refresh_tag + """    <title>""" + title_prefix + """Subagent Description Optimization</title>
...
def main():
    ...
    parser.add_argument("--agent-name", default="", help="Subagent name to include in the report title")
    ...
    html_output = generate_html(data, agent_name=args.agent_name)
