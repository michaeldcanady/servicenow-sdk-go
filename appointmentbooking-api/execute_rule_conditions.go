...
func (m *ExecuteRuleConditionsRequestModel) GetCatalogId() (*string, error) { return store.DefaultBackedModelAccessorFunc[kiotaStore.BackingStore, *string](m.GetBackingStore(), catalogIdKey) }
func (m *ExecuteRuleConditionsRequestModel) setCatalogId(val *string) error { return store.DefaultBackedModelMutatorFunc(m.GetBackingStore(), catalogIdKey, val) }
func (m *ExecuteRuleConditionsRequestModel) GetOtherInputs() (any, error) { return store.DefaultBackedModelAccessorFunc[kiotaStore.BackingStore, any](m.GetBackingStore(), otherInputsKey) }
func (m *ExecuteRuleConditionsRequestModel) setOtherInputs(val any) error { return store.DefaultBackedModelMutatorFunc(m.GetBackingStore(), otherInputsKey, val) }
func (m *ExecuteRuleConditionsRequestModel) GetTaskId() (*string, error) { return store.DefaultBackedModelAccessorFunc[kiotaStore.BackingStore, *string](m.GetBackingStore(), taskIdKey) }
func (m *ExecuteRuleConditionsRequestModel) setTaskId(val *string) error { return store.DefaultBackedModelMutatorFunc(m.GetBackingStore(), taskIdKey, val) }
...
func (m *ExecuteRuleConditionsResultModel) GetDedicatedCapacity() (*bool, error) { return store.DefaultBackedModelAccessorFunc[kiotaStore.BackingStore, *bool](m.GetBackingStore(), dedicatedCapacityKey) }
func (m *ExecuteRuleConditionsResultModel) setDedicatedCapacity(val *bool) error { return store.DefaultBackedModelMutatorFunc(m.GetBackingStore(), dedicatedCapacityKey, val) }
func (m *ExecuteRuleConditionsResultModel) GetFutureMaxBookableDays() (*string, error) { return store.DefaultBackedModelAccessorFunc[kiotaStore.BackingStore, *string](m.GetBackingStore(), futureMaxBookableDaysKey) }
func (m *ExecuteRuleConditionsResultModel) setFutureMaxBookableDays(val *string) error { return store.DefaultBackedModelMutatorFunc(m.GetBackingStore(), futureMaxBookableDaysKey, val) }
func (m *ExecuteRuleConditionsResultModel) GetRuleId() (*string, error) { return store.DefaultBackedModelAccessorFunc[kiotaStore.BackingStore, *string](m.GetBackingStore(), ruleIdKey) }
func (m *ExecuteRuleConditionsResultModel) setRuleId(val *string) error { return store.DefaultBackedModelMutatorFunc(m.GetBackingStore(), ruleIdKey, val) }
func (m *ExecuteRuleConditionsResultModel) GetRuleName() (*string, error) { return store.DefaultBackedModelAccessorFunc[kiotaStore.BackingStore, *string](m.GetBackingStore(), ruleNameKey) }
func (m *ExecuteRuleConditionsResultModel) setRuleName(val *string) error { return store.DefaultBackedModelMutatorFunc(m.GetBackingStore(), ruleNameKey, val) }
