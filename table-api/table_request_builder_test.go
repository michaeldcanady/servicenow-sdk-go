...
func TestTableRequestBuilder_Get(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			err: errors.New("resp is not *model.ServiceNowCollectionResponse[*github.com/michaeldcanady/servicenow-sdk-go/table-api.TableRecord]"),
		},
	}
...
func TestTableRequestBuilder_Post(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectErr: true,
			err:       errors.New("resp is not *model.ServiceNowItemResponse[*github.com/michaeldcanady/servicenow-sdk-go/table-api.TableRecord]"),
		},
	}
