...
- **[Upload from disk](upload-from-disk.mdx):** Attach a local file to a record.
- **[Download record attachments](download-record-attachments.mdx):** Save every
  attachment on a record locally.
- **[Find the most recent attachment](most-recent-attachment.mdx):** Sort and
  select the newest file.
- **[Delete aging attachments](delete-aging-attachments.mdx):** Enforce
  retention policies.
...
- **[Table Operations](../tables/index.mdx):** Learn more about managing the records
