---
title: 'ADR 007: Don''t scaffold a builder chain ahead of an implemented operation'
description: >-
  A request-builder accessor exists only once the operations behind it are
