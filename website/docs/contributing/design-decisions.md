...
to its **Architecture Decision Record (ADR)** in the [ADR collection](./adr/001-error-standardization.md),
which is the primary source when you want the deeper technical why and how,
...
1. **Write the ADR** in the [ADR collection](./adr/001-error-standardization.md) — context, decision,
