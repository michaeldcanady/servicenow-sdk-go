...
Visual Studio Code Dev Containers or a manual local setup.
...
## Option 1: Visual Studio Code Dev Containers (Recommended)

The easiest way to get started is using Visual Studio Code Dev Containers. This
method automatically configures a consistent environment with all necessary
tools (Go, linters, and extensions).
...
credentials. Create a `.env` file in the project root (git doesn't track this
file):
...
[project architecture](architecture.md) to understand how the project organizes
the SDK.
