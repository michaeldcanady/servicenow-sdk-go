...
- **[Query Builder](query-builder.mdx):** A type-safe and readable way to
  construct complex ServiceNow Encoded Queries.

## Next steps

- **[Feedback](https://github.com/michaeldcanady/servicenow-sdk-go/issues):**
  If you encounter issues or have suggestions, please open an issue on GitHub.
- **[Query Builder](query-builder.mdx):** Learn more about the query builder.
