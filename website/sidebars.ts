...
const sidebars: SidebarsConfig = {
  ...
  contributing: [
    ...
    },
    {
      ...
      collapsed: false,
      items: ['contributing/triage', 'contributing/grooming'],
    },
    {
      type: 'category',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'contributing/adr/001-error-standardization',
        'contributing/adr/002-backing-store-models',
        'contributing/adr/003-hand-written-on-kiota',
        'contributing/adr/004-vanilla-kiota-request-configuration',
        'contributing/adr/005-generic-page-iterator-only',
        'contributing/adr/006-nil-receiver-sentinel-error',
        'contributing/adr/007-no-speculative-builder-chains',
        'contributing/adr/008-package-symbol-url-naming-independence',
        'contributing/adr/009-requestbuilder-requestinformation-naming',
        'contributing/adr/010-no-nerdit-tech-migration',
      ],
    },
  ],
};
