    ...
    },
    {
      ...
      items: [
        ...
        'contributing/design-error-handling',
        {
          ...
          link: { type: 'doc', id: 'contributing/adrs/index' },
          items: [
            'contributing/adrs/001-error-standardization',
            'contributing/adrs/002-backing-store-models',
            'contributing/adrs/003-hand-written-on-kiota',
            'contributing/adrs/004-vanilla-kiota-request-configuration',
            'contributing/adrs/005-generic-page-iterator-only',
            'contributing/adrs/006-nil-receiver-sentinel-error',
            'contributing/adrs/007-no-speculative-builder-chains',
            'contributing/adrs/008-package-symbol-url-naming-independence',
